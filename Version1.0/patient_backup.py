...
one_patient_info.write(0, 7, label='备注')
    ...
    def info_search(self):
        ...
        while a:
            if int(self.table.cell(i, 0).value) == int_src:
                ...
                a = False
                break
            elif int(self.table.cell(i, 0).value) != int_src:
                i = i+1
            elif int(self.table.cell(i, 0).value) == 0:
                a = False
                break
            break
...
class gui_root():
    ...
    def set_ims_window(self):
        ...
        self.diseasemenu.add_command(label="New", command=self.hello)
        self.diseasemenu.add_command(label="Search", command=self.hello)
